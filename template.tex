...
\vfill
\begin{quote}
This research was supported by the project \enquote{Romanian Hub for Artificial
Intelligence -- HRIA}, Smart Growth, Digitization and Financial Instruments Program,
2021-2027, MySMIS no. 351416.
\end{quote}

\bigskip

\begin{center}
{\hypersetup{urlcolor=black} \qrcode[height=0.2\paperwidth]{https://hria.upb.ro}}

\medskip
\url{https://hria.upb.ro.}
\end{center}
\vfill
\end{frame}
